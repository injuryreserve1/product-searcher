...
//   let results: any[] = [];
//   const TARGET_VALID_COUNT = 7;

//   try {
//     for (const targetUrl of validSites) {
//       if (results.length >= TARGET_VALID_COUNT) {
//         console.log(
//           `[scraper] Набрано необходимое количество товаров (${TARGET_VALID_COUNT}). Остановка.`,
//         );
//         break;
//       }
//       console.log(`\n--- Обработка: ${targetUrl} ---`);
...
//                 lowerHref.includes("/card/") ||
//                 lowerHref.includes("/p/");
//               const isTrash =
//                 lowerHref.includes("/reviews") ||
//                 lowerHref.includes("/spec") ||
//                 lowerHref.includes("/otzyvy");

//               if (isProduct && !isTrash) {
//                 try {
...
//               if (isOutOfStock) {
//                 console.log(
//                   `[scraper] Товар по ссылке ${link} отсутствует в наличии. Пропускаем.`,
//                 );
//                 continue;
//               }
